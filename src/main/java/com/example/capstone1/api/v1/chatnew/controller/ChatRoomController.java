...
public class ChatRoomController {
    ...
    @GetMapping("/OwnchatRoomList")
    public ResponseEntity OwnChatRoomList(){
        List<ChatRoomResponseDto.ListResponse> responses = chatRoomService.findChatRoomByUserName();
        return response.success(responses, "유저 채팅방 리스트 조회에 성공했습니다.");
    ...
    public ResponseEntity createRoom(@RequestBody ChatRoomRequestDto.Post post){
        log.info(post.getUsername()+"컨트롤러 여기서 확인!!!!!!");
